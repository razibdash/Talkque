...
const sections = ["Messages", "Tool calls", "Answer audit", "Raw webhook payload"];
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Inspect transcript, tool calls, answer trust layer, retrieved chunks, and provider payload."
        actions={<Button>Replay call</Button>}
      />

...
const sections = ["Inbound calls", "Outbound calls", "Failed calls", "Escalated calls"];
...
export default function CallsPage() {
  return (
    <div>
      <PageHeader
        title="Calls"
        description="Browse voice conversations, transcripts, sentiment, answer events, and escalations."

...
const sections = ["Language trends", "Hot topics", "Sentiment", "Latency"];
...
export default function AnalyticsPage() {
  return (
    <div>
      <PageHeader
        title="Analytics"
        description="Language distribution, hot topics, sentiment trends, peak hours, and provider latency."

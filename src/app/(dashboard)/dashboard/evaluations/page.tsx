...
const sections = ["Test sets", "Test cases", "Eval runs", "Failures"];
...
export default function EvaluationsPage() {
  return (
    <div>
      <PageHeader
        title="Evaluations"
        description="Run test cases before publishing an agent version to prevent quality regressions."
        actions={<Button>Run evaluation</Button>}
      />

...
const sections = ["Profile", "Locations", "Localization", "Workspace metadata"];
...
export default function OrganizationPage() {
  return (
    <div>
      <PageHeader
        title="Organization"
        description="Manage organization profile, locations, country, timezone, locale, and billing email."

...
const sections = ["Draft versions", "Published versions", "Rollback history", "Change notes"];
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Every production configuration is versioned for debugging and auditability."
        actions={<Button>Create version</Button>}
      />

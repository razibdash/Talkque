...
const sections = ["System prompt", "Voice settings", "RAG configuration", "Escalation rules"];
...
export default function AgentDetailPage() {
  return (
    <div>
      <PageHeader
        title="Agent detail"
        description="Manage prompt, provider settings, languages, voice, RAG, and escalation rules."
        actions={<Button>Publish version</Button>}
      />

...
const sections = ["Voice minutes", "LLM tokens", "Embedding tokens", "Messages"];
...
export default function BillingPage() {
  return (
    <div>
      <PageHeader
        title="Billing"
        description="Plans, subscriptions, usage events, daily rollups, and estimated provider costs."
        actions={<Button>Manage plan</Button>}
      />
